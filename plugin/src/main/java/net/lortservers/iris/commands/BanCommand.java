    ...
    protected void construct(Command.Builder<CommandSenderWrapper> commandSenderWrapperBuilder, CommandManager<CommandSenderWrapper> manager) {
        manager.command(
                commandSenderWrapperBuilder
                        ...
                        .argument(StringArgument.optional("reason", TranslationManager.getInstance().getRawMessage("banMessageCheating")))
                        .handler(commandContext -> {
                            ...
                            commandContext.getSender().sendMessage(
                                    TranslationManager.getInstance().getMessage("banCommandSuccess", Map.of("player", player.orElseThrow().getName()), commandContext.getSender().getLocale())
                            );
                        })
        );
    }
